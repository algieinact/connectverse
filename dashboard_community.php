            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="p-4">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div>
                                            <h5 class="card-title mb-0">
                                                <?php echo htmlspecialchars($community['name']); ?></h5>
                                            <small
                                                class="text-muted"><?php echo htmlspecialchars($community['category_name']); ?></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <small class="text-muted">
                                            <i class="fas fa-users me-1"></i><?php echo $community['member_count']; ?>
                                            member
                                        </small>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="dashboard_community.php" class="btn btn-secondary">
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name"
                                                value="<?php echo $action === 'edit' ? htmlspecialchars($community['name']) : ''; ?>"
                                                required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description" name="description"
                                                rows="4"><?php echo $action === 'edit' ? htmlspecialchars($community['description']) : ''; ?></textarea>
                                        </div>
                                        ...
                                        <div class="d-flex gap-2">
                                            <button type="submit" class="btn btn-primary">
                                                <i
                                                    class="fas fa-save me-2"></i><?php echo $action === 'create' ? 'Buat Komunitas' : 'Update Komunitas'; ?>
                                            </button>
